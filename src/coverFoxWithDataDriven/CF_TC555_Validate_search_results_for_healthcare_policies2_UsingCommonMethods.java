...
public class CF_TC555_Validate_search_results_for_healthcare_policies2_UsingCommonMethods {
	...
	public static void main(String[] args) throws InterruptedException, EncryptedDocumentException, IOException
	{
		...
		Thread.sleep(1000);
		membersDetails.hanldeAgeDropDown(CommonlyUsedMethod.readDataFromExcel("CoverFoxData", 1, 0));
		Thread.sleep(1500);
		membersDetails.clickOnNextButton();
		
		CoverFoxAddressDetailsPage addressDetails= new CoverFoxAddressDetailsPage(driver);
		Thread.sleep(1500);
		addressDetails.enterPinCode(CommonlyUsedMethod.readDataFromExcel("CoverFoxData", 1, 1));
		Thread.sleep(1500);
		addressDetails.enterMobNum(CommonlyUsedMethod.readDataFromExcel("CoverFoxData", 1, 2));
		Thread.sleep(1500);
